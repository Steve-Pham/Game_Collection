...
public class Enemy_4 : Enemy
{
     ...
     private int score4; // This contains the score when enemy 4 is killed
     public GameObject projectivePrefab; // Projectile Prefab for shooting

     void Start()
     {
          score4 = Settings.getScore(4);
     ...
     // Method to obtain score for killing enemey 4
     public int getScore()
     {
          return this.score4; 
     }
               ...
               case "ProjectilePlayer":
                    ...
                    { // If it IS completely destroyed... // j
                      // ...tell the Main singleton that this ship was destroyed
                         Main.enemiesScreen--;
                         Main.S.shipDestroyed(this, score4);
                         // Destroy this Enemy
